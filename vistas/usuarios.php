			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmRegistro">
						...
						<p></p>
						<span style="background: black; border-color: salmon" class="btn btn-primary" id="registro">Registrar</span>
			...
			<div class="modal-dialog modal-sm" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button style="background: black; border-color: salmon" id="btnActualizaUsuario" type="button" class="btn btn-warning" data-dismiss="modal">Actualiza Usuario</button>
