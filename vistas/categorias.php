			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmCategorias">
						...
						<p></p>
						<span style="background: black; border-color: salmon" class="btn btn-primary" id="btnAgregaCategoria">Agregar</span>
					</form>
				</div>
				<div class="col-sm-6">
			...
			<div class="modal-dialog modal-sm" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button style="background: black; border-color: salmon" type="button" id="btnActualizaCategoria" class="btn btn-warning" data-dismiss="modal">Guardar</button>
