			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmClientes">
						...
						<p></p>
						<span style="background: black; border-color: salmon" class="btn btn-primary" id="btnAgregarCliente">Agregar</span>
					</form>
				</div>
				<div class="col-sm-8">
			...
			<div class="modal-dialog modal-sm" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button style="background: black; border-color: salmon" id="btnAgregarClienteU" type="button" class="btn btn-primary" data-dismiss="modal">Actualizar</button>
